...
- [x] Make Figure and Lede ~~and the standard Gatsby Link~~ (solved, I think, by `gatsby-plugin-catch-links`) into mdx shortcodes for easier use
- [ ] Set up RSS feed
...
- [x] Think about maybe moving content out of the src folder
- [x] Set correct font in code blocks
- [x] Make inline code blocks smaller to fit with the body font
...
- [x] Fix fouc on page load (Fixed as far as I can tell)
